...
Dockerized ComfyUI workflow: SeedVR2_4K_image_upscale.json
...
docker build -t seedvr2_4k_image_upscale.json .

# Run the container
docker run -p 8188:8188 seedvr2_4k_image_upscale.json
```
